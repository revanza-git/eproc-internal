...
class Main extends CI_Controller
{
	...
	public function rekapFPPBJ($year)
	{
		...
		$width_fppbj_selesai = ($fppbj_selesai->num_rows() / $total_fppbj_semua->num_rows()) * 100;
		...
		<div class="scrollbar" id="custom-scroll" style="height: 538px">
		  ...
		  <div class="summary">
			<div class="summary-title">
			  FPPBJ Selesai
			  <span>' . $fppbj_selesai->num_rows() . '/' . $total_fppbj_semua->num_rows() . '</span>
			</div>
		...
		$width_pending = ($fppbj_pending->num_rows() / $total_fppbj_semua->num_rows()) * 100;
		$res .= '</div>
		  </div>
		  <div class="summary">
			<div class="summary-title">
			  Belum disetujui User
			  <span>' . $fppbj_pending->num_rows() . '/' . $total_fppbj_semua->num_rows() . '</span>
			</div>
			<div class="summary-bars">
		...
		$width_admin_hsse = ($pending_admin_hsse->num_rows() / $total_fppbj_semua->num_rows()) * 100;
		$res .= '</div>
		  </div>		  
		  <div class="summary">
			<div class="summary-title">
			  Belum disetujui HSSE
			  <span>' . $pending_admin_hsse->num_rows() . '/' . $total_fppbj_semua->num_rows() . '</span>
			</div>
			<div class="summary-bars">
		...
		$width_admin_pengendalian = ($pending_admin_pengendalian->num_rows() / $total_fppbj_semua->num_rows()) * 100;
		$res .= '</div>
		  </div>
		  <div class="summary">
			<div class="summary-title">
			  Belum disetujui Admin Pengendalian
			  <span>' . $pending_admin_pengendalian->num_rows() . '/' . $total_fppbj_semua->num_rows() . '</span>
			</div>
			<div class="summary-bars">
		...
		$width_kadept_proc = ($pending_kadept_proc->num_rows() / $total_fppbj_semua->num_rows()) * 100;
		$res .= '</div>
		  </div>
		  <div class="summary">
			<div class="summary-title">
			  Belum disetujui Ka.Dept Procurement
			  <span>' . $pending_kadept_proc->num_rows() . '/' . $total_fppbj_semua->num_rows() . '</span>
			</div>
			<div class="summary-bars">
		...
		$width_pending_dir = ($total_pending_dir->num_rows() / $total_fppbj_semua->num_rows()) * 100;
		$res .= '</div>
		  </div>
		  <div class="summary">
			<div class="summary-title">
			  Belum disetujui Pejabat Pengadaan
			  <span>' . $total_pending_dir->num_rows() . '/' . $total_fppbj_semua->num_rows() . '</span>
			</div>
			<div class="summary-bars">
		...
		$width_reject = ($fppbj_reject->num_rows() / $total_fppbj_semua->num_rows()) * 100;
		$res .= '</div>
		...
		$res .= '</div>
		  ...
		  <div class="summary">
			<div class="summary-title">
			  Tidak Disetujui
			  <span>' . $fppbj_reject->num_rows() . '/' . $total_fppbj_semua->num_rows() . '</span>
			</div>
			<div class="summary-bars">
	...
	public function rekapFKPBJ($year)
	{
		...
		<div class="scrollbar" id="custom-scroll" style="height: 538px">
		  ...
		  <div class="summary">
			<div class="summary-title">
			  FKPBJ Selesai
			  <span>' . $fkpbj_success->num_rows() . '/' . $total_fkpbj->num_rows() . '</span>
			</div>
			<div class="summary-bars">
		...
		$res .= '</div>
              ...
              <div class="summary">
                <div class="summary-title">
                  Belum disetujui User
                  <span>' . $fkpbj_pending->num_rows() . '/' . $total_fkpbj->num_rows() . '</span>
                </div>
                <div class="summary-bars">
		...
		$res .= '</div>
              ...
              <div class="summary">
                <div class="summary-title">
                  ...
                  <span>' . $fkpbj_pending_ap->num_rows() . '/' . $total_fkpbj->num_rows() . '</span>
                </div>
                <div class="summary-bars">
		...
		$res .= '</div>
              ...
              <div class="summary">
                <div class="summary-title">
                  Belum disetujui Ka.Dept Procurement
                  <span>' . $fkpbj_pending_kp->num_rows() . '/' . $total_fkpbj->num_rows() . '</span>
                </div>
                <div class="summary-bars">
		...
		$res .= '</div>
              ...
              <div class="summary">
                <div class="summary-title">
                  Tidak Disetujui
                  <span>' . $fkpbj_reject->num_rows() . '/' . $total_fkpbj->num_rows() . '</span>
                </div>
                <div class="summary-bars">
                  <span class="bar-top is-danger" style="width:' . $width_fkpbj_reject . '%"></span>
                  <span class="bar-bottom"></span>
                </div>
                <button class="accordion-header">Tidak disetujui <span class="badge is-danger">' . $fkpbj_reject->num_rows() . '</span><span class="icon"><i class="fas fa-angle-down"></i></span></button>
				<div class="accordion-panel">';
		$no = 1;
		foreach ($fkpbj_reject->result() as $key) {
			$res .= '<p>' . $no . '. <a href="' . site_url('pemaketan/division/' . $key->id_division . '/' . $key->id . '/' . date('Y', strtotime($key->entry_stamp))) . '">' . $key->nama_pengadaan . '</a></p>';
			$no++;
		}
		$res .= '</div>
	...
	public function rekapFP3($year)
	{
		...
		$res .= '</div>
              ...
              <div class="summary">
                <div class="summary-title">
                  Belum disetujui Pejabat Pengadaan
                  <span>' . $fp3_pending_aldir->num_rows() . '/' . $total_fp3->num_rows() . '</span>
                </div>
                <div class="summary-bars">
