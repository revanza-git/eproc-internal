              ...
              <div class="summary">
                ...
                <div class="accordion-panel">
                  <?php $no = 1; foreach ($fppbj_selesai->result() as $key) { ?>
                    <p><?= $no.'. <a href="'.site_url('pemaketan/division/'.$key->id_division).'">'.$key->nama_pengadaan.'</a>' ?></p>
                  <?php $no++;} ?>
                </div>
              </div>
              ...
              <div class="is-block">
                ...
                <div class="accordion-panel">
                  <?php foreach ($pending_dirut->result() as $key) { ?>
                    <p><?= '<a href="'.site_url('pemaketan/division/'.$key->id_division).'">'.$key->nama_pengadaan.'</a>' ?></p>
                  <?php } ?>
                </div>
