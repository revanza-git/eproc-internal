...
<head>
    ...
    <style>
      ...
      button:hover {
        -webkit-box-shadow: 0 6px 32px 0 rgba(0,0,255,.3);
        box-shadow: 0 6px 32px 0 rgba(0,0,255,.3);
      }
...
<body>
  ...
  <div class="center">
    <button onclick="window.location.href='<?php #echo base_url();?>http://127.0.0.1/eproc_nr'">Back to Home</button>
  </div>
  ...
  <script>
    ...
    // TweenMax.to('#squidFront #tent3', 2, {
    //   rotation:8, 
